  ...
  return (
    <Layout>
      <section className="terms-of-service container">
        <h1 className="mt-10">Terms and Conditions</h1>
        <p>
          <strong>Last updated:</strong> December 01, 2023
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Country</strong> refers to: United States, Vietnam, United
            Kingdom, Canada, Australia, Germany, France, Singapore, Japan.
          </li>
          <li>
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to Amazing.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Amazing, accessible from{" "}
            <a href="https://newswatch24.com/">https://newswatch24.com/</a>
          </li>
          <li>
        ...
        <p>
          ...
          faults and defects without warranty of any kind. The Company provides
          no warranty that the Service will meet Your requirements or be error
          free.
        </p>
