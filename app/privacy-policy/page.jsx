...
export default function PrivacyPolicy() {
  return (
    <Layout>
      <article className="privacy-policy container mx-auto p-6">
        <h1 className="text-2xl font-bold mb-4 mt-10">Privacy Policy</h1>

        <p className="mb-2">
          At <strong>newswatch24.com</strong>, accessible from{" "}
          <a href="https://newswatch24.com/">https://newswatch24.com</a>, one of
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by <strong>newswatch24.com</strong> and how we use it.
        </p>
        ...
        <p className="mb-4">
          ...
          shared and/or collect in <strong>newswatch24.com</strong>. This policy
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">Log Files</h2>
        <p className="mb-4">
          <strong>newswatch24.com</strong> follows a standard procedure of using
        ...
        <p className="mb-4">
          Like any other website, <strong>newswatch24.com</strong> uses
        ...
        <p className="mb-4">
          ...
          based upon their visit to <strong>https://newswatch24.com/</strong>{" "}
          and other sites on the internet. However, visitors may choose to
          decline the use of DART cookies by visiting the Google ad and content
        ...
        <p className="mb-4">
          ...
          advertising partners of <strong>newswatch24.com</strong>.
        </p>
        <p className="mb-4">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on{" "}
          <strong>newswatch24.com</strong>, which are sent directly to users'
        ...
        <p className="mb-4">
          Note that <strong>newswatch24.com</strong> has no access to or control
        ...
        <p className="mb-4">
          <strong>newswatch24.com</strong>'s Privacy Policy does not apply to
        ...
        <p className="mb-4">
          <strong>newswatch24.com</strong> does not knowingly collect any
        ...
        <footer className="mt-8 border-t pt-4 text-sm text-gray-600">
          <p>
            <strong>Business markets:</strong> Primary focus: United States.
            Also targeting: European Union, Vietnam, United Kingdom, Canada,
            Australia, Germany, France, Singapore, Japan.
          </p>
          <p className="mt-2">
            This policy is intended to help with compliance for advertising and
            ad networks (e.g., Google Ads / AdSense) and privacy regulations
            (CCPA, GDPR). For full legal compliance, consider consulting a
            lawyer experienced in international privacy laws.
          </p>
        </footer>
      </article>
    </Layout>
